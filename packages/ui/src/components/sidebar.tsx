...
// biome-ignore lint/performance/noNamespaceImport: shadcn sidebar uses the React namespace
...
function SidebarProvider({
	...
	const setOpen = React.useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// biome-ignore lint/suspicious/noDocumentCookie: persists sidebar open/closed state
